...
## By [Kiptoo Rugut](https://github.com/KiptooRugut) ,March 2022
...
* Run `git clone https://github.com/KiptooRugut/Blog-Website.git`
* Run `cd Blog-Website` command to confirm it was successfully cloned.
